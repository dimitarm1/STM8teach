...
本章讲述关于C语言的一些细节，希望在具体开发前能够给读者打下一定的C语言的基础。第一节列出了一些题目，并且提供了一些有趣的C语言读物，旨在给读者带来一定的思考。后面的几节，是作者挑选出来的几个点，旨在能够将STM8开发需要的C语言技巧包括进去。最后一节，列出了一些C语言的经典书籍，旨在让读者对C语言有一个进阶性的了解。
